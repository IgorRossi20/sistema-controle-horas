...
try {
  ...
  console.log('📊 Dados disponíveis:', {
    clients: localStorageService.queryDocuments('clients').length,
    projects: localStorageService.queryDocuments('projects').length,
    timeEntries: localStorageService.queryDocuments('timeEntries').length
  })
} catch (error) {
