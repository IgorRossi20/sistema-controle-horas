...
// Teste: 30min=0.30h, 60min=1.00h, 90min=1.30h

console.log('🧪 TESTANDO CÁLCULOS DE HORAS');
console.log('Regra: 60 minutos = 1 hora, 30 minutos = 0.30 horas');
console.log('Formato: H.MM onde MM são os minutos (não centésimos)');
...
console.log(`✅ Esperado: 0.30h | Resultado: ${test1_result === '0.30' ? '✅ CORRETO' : '❌ INCORRETO'}`);

// Teste 2: 60 minutos = 1.00 hora
console.log('\n🔸 Teste 2: 60 minutos');
...
console.log(`✅ Esperado: 1.30h | Resultado: ${test3_result === '1.30' ? '✅ CORRETO' : '❌ INCORRETO'}`);
...
// Teste 5: 150 minutos = 2.30 horas
console.log('\n🔸 Teste 5: 150 minutos');
...
console.log(`✅ Esperado: 2.30h | Resultado: ${test5_result === '2.30' ? '✅ CORRETO' : '❌ INCORRETO'}`);

// Teste 6: 45 minutos = 0.45 horas
console.log('\n🔸 Teste 6: 45 minutos');
...
console.log(`✅ Esperado: 0.45h | Resultado: ${test6_result === '0.45' ? '✅ CORRETO' : '❌ INCORRETO'}`);

console.log('\n🎯 RESUMO DOS TESTES:');
console.log('- 30 min = 0.30h:', test1_result === '0.30' ? '✅' : '❌');
console.log('- 60 min = 1.00h:', test2_result === '1.00' ? '✅' : '❌');
console.log('- 90 min = 1.30h:', test3_result === '1.30' ? '✅' : '❌');
console.log('- 120 min = 2.00h:', test4_result === '2.00' ? '✅' : '❌');
console.log('- 150 min = 2.30h:', test5_result === '2.30' ? '✅' : '❌');
console.log('- 45 min = 0.45h:', test6_result === '0.45' ? '✅' : '❌');
